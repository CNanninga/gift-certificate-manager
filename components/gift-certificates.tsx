...
/**
 * Data layer for the listing. Fetches the gift certificates for the given
 * filter/sort props. Filtering and sorting are applied inside the fetch (as a
 * real query would), not after the fact. The dynamic request data (search
 * params) is read upstream in GiftCertificatesPage and handed in as props.
 */
